...
Welcome to my B.Tech Major project! This tool is designed to automate the creation of test benches for a custom designed MIPS processors for a given assembly file. `Navya B`, [Nidhin Chandran](https://github.com/Nidhinchandran47), `Sarun Babu` and `Vishnu P` where also with me during this Project
