...
Welcome to my B.Tech Major project! This tool is designed to automate the creation of test benches for a custom designed MIPS processors for a given assembly file. `Navya B`, [Prajwal KP](https://github.com/prajwal19012002/), `Sarun Babu` and [Vishnu P](https://github.com/vishnuponneth) where also with me during this Project
